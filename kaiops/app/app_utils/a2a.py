...
def _resolve_app_url(app_url: str | None) -> str:
    ...
    # an invalid "global-aiplatform.googleapis.com" URL. Use the runtime-injected
    # agent-engine infra region; guard model-endpoint aliases (global/us/eu).
    location = os.getenv("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION", "us-central1")
    if location in ("global", "us", "eu", "global-aiplatform"):
