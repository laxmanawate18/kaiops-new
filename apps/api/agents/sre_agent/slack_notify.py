...
def notify_slack(channel: str, message: str, session_link: str = "") -> str:
    ...
    Args:
        ...
        session_link: Optional deep-link URL to the console session so a
            developer can click straight into the ongoing incident conversation.
    ...
    if session_link:
        # Append a clickable link to the console session (markdown link).
