"""
Azure Application Resolver - Dynamically resolves application metadata to AKS information.
"""
...
class AppResolver:
        ...
        try:
            ...
            if app:
                app_dict = {
                    ...
                    "namespace": app.get("namespace") or "kaiops-ns",
    ...
    def resolve_pod_info(cls, app_name: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "namespace": meta.get("namespace", "kaiops-ns"),
...
def get_ingress_info(app_name: str) -> Dict[str, Any]:
    meta = AppResolver.get_app_metadata(app_name)
    if not meta:
        return {"error": f"Application '{app_name}' not found"}
    return {
        "application_name": meta.get("application_name"),
